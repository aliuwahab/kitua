...
return [
    ...
    'title' => 'Kitua Mobile Payment API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'REST API for Kitua mobile payment app supporting group payments and individual payment requests',
    ...
    'auth' => [
        ...
        'extra_info' => 'You can retrieve your token by completing the registration/login flow via the `/api/v1/auth/register` and `/api/v1/auth/verify-pin` endpoints.',
    ],
